...
RUN sudo ./dotnet-install.sh --channel 5.0
RUN sudo ./dotnet-install.sh --channel 6.0
RUN sudo ./dotnet-install.sh --channel 7.0
RUN sudo ./dotnet-install.sh --channel 8.0
